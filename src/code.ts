...
import { resolve, type Value } from "./data";
...
const semantics = grammar.createSemantics().addOperation<Value>("eval(scope)", {
  Exp(e) {
...
export function evalExpr(src: string, scope: (name: string) => Value): Value {
